...
def gen_items(pod_types=[4], 
              total_sku=7024, 
              items_class_conf={"A": 0.02, "B": 0.25, "C": 0.73}, 
              items_pods_inventory_levels={"A": 1, "B": 1, "C": 1}, 
              items_warehouse_inventory_levels={"A": 1, "B": 1, "C": 1},
              select_option=1, 
              dev_mode=False):
...
def config_items_pods(pod_types=[4], pod_num=[240], total_sku=7024, 
                      items_class_conf={"A": 0.02, "B": 0.25, "C": 0.73},
                      items_pods_inventory_levels={"A": 1, "B": 1, "C": 1},
                      items_warehouse_inventory_levels={"A": 1, "B": 1, "C": 1},
                      items_pods_class_conf={"A": 0.1, "B": 0.36, "C": 0.54},
                      dev_mode=False):
...
if __name__ == "__main__":
    ...
    total_sku = 7024
    items_class_conf = {"A": 0.02, "B": 0.25, "C": 0.73}
    items_pod_inventory_levels = {"A": 1, "B": 1, "C": 1}
    items_warehouse_inventory_levels = {"A": 1, "B": 1, "C": 1}
    items_pods_class_conf = {"A": 0.1, "B": 0.36, "C": 0.54}
