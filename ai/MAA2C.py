...
from ai.utilities.Agent import Agent
from ai.utilities.Model import ActorNetwork, CriticNetwork
from ai.utilities.Model_utils import entropy, index_to_one_hot, to_tensor_var
...
class MAA2C(Agent):
    ...
    def __init__(self, env, n_agents, state_dim, action_dim,
                 ...
                 actor_parameter_sharing=True, critic_parameter_sharing=True):
